...
export default function SocialMediaMonitoring() {
  ...
  // =========================================================================
  // HALAMAN UTAMA (UKURAN TETAP, EFEK HOVER GELAP PEKAT DIPERBAIKI)
  // =========================================================================
  if (currentPage === "main") {
      ...
      <main className="h-screen w-screen overflow-hidden bg-[#0d1117] flex flex-col items-center justify-center p-4">
        ...
        <div className="flex flex-col items-center gap-8 w-full">
          ...
          <div className="text-center space-y-2">
            <h1 className="text-4xl md:text-5xl font-black text-white tracking-tight">Public Trend Radar</h1>
            <p className="text-gray-400 text-base font-medium">Monitoring isu publik terupdate secara real-time.</p>
          </div>
          ...
          <div className="flex flex-col gap-6 items-center w-full">
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              {/* Nasional */}
              <div className={boxCard} style={{ width: '280px', height: '280px' }}>
                ...
                {/* INI KUNCI EFEK GELAPNYA: bg-black/90 dan z-10 */}
                <div className="absolute inset-0 bg-black/90 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-center items-center p-5 z-10">
                  <h2 className="text-white font-bold text-xl mb-5 text-center transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">Berita Nasional</h2>
                  <div className="flex flex-col gap-3 w-full max-w-[180px] transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-75">
                    <button onClick={() => setCurrentPage("12jam")} className="bg-blue-600 hover:bg-blue-500 text-white py-2.5 rounded-lg text-sm font-bold w-full flex items-center justify-center gap-1.5"><TrendingUp size={16}/> Top News</button>
                    <button onClick={() => setCurrentPage("terkini")} className="bg-blue-600 hover:bg-blue-500 text-white py-2.5 rounded-lg text-sm font-bold w-full flex items-center justify-center gap-1.5"><Zap size={16}/> Terkini</button>
                  </div>
                </div>
              </div>
              ...
              <div className={boxCard} style={{ width: '280px', height: '280px' }}>
                ...
                <div className="absolute inset-0 bg-black/90 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-center items-center p-5 z-10">
                  <h2 className="text-orange-400 font-bold text-xl mb-5 text-center transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">Bencana Terkini</h2>
                  <div className="flex flex-col gap-3 w-full max-w-[180px] transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-75">
                    <button onClick={() => setCurrentPage("bencana-24jam")} className="bg-orange-600 hover:bg-orange-500 text-white py-2.5 rounded-lg text-sm font-bold w-full flex items-center justify-center gap-1.5"><AlertTriangle size={16}/> Radar Bencana</button>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <div className={boxCard} style={{ width: '280px', height: '280px' }}>
                ...
                <div className="absolute inset-0 bg-black/90 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-center items-center p-5 z-10">
                  <h2 className="text-red-400 font-bold text-xl mb-5 text-center transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">PDI Perjuangan</h2>
                  <div className="flex flex-col gap-3 w-full max-w-[180px] transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-75">
                    <button onClick={() => setCurrentPage("pdip-12jam")} className="bg-red-600 hover:bg-red-500 text-white py-2.5 rounded-lg text-sm font-bold w-full flex items-center justify-center gap-1.5"><TrendingUp size={16}/> Top News</button>
                    <button onClick={() => setCurrentPage("pdip-terkini")} className="bg-red-600 hover:bg-red-500 text-white py-2.5 rounded-lg text-sm font-bold w-full flex items-center justify-center gap-1.5"><Zap size={16}/> Terkini</button>
                  </div>
                </div>
              </div>
              ...
              <div className={boxCard} style={{ width: '280px', height: '280px' }}>
                ...
                <div className="absolute inset-0 bg-black/90 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-center items-center p-5 z-10">
                  <h2 className="text-red-400 font-bold text-xl mb-5 text-center transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">Megawati</h2>
                  <div className="flex flex-col gap-3 w-full max-w-[180px] transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-75">
                    <button onClick={() => setCurrentPage("megawati-12jam")} className="bg-red-600 hover:bg-red-500 text-white py-2.5 rounded-lg text-sm font-bold w-full flex items-center justify-center gap-1.5"><TrendingUp size={16}/> Top News</button>
                    <button onClick={() => setCurrentPage("megawati-terkini")} className="bg-red-600 hover:bg-red-500 text-white py-2.5 rounded-lg text-sm font-bold w-full flex items-center justify-center gap-1.5"><Zap size={16}/> Terkini</button>
                  </div>
                </div>
              </div>
              ...
              <div className={boxCard} style={{ width: '280px', height: '280px' }}>
                ...
                <div className="absolute inset-0 bg-black/90 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-center items-center p-5 z-10">
                  <h2 className="text-red-400 font-bold text-xl mb-4 text-center transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">Puan Maharani</h2>
                  <div className="flex flex-col gap-2.5 w-full max-w-[180px] transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-75">
                    <button onClick={() => setCurrentPage("puan-12jam")} className="bg-red-600 hover:bg-red-500 text-white py-2 rounded-lg text-sm font-bold w-full flex items-center justify-center gap-1.5"><TrendingUp size={16}/> Top News</button>
                    <button onClick={() => setCurrentPage("puan-terkini")} className="bg-red-600 hover:bg-red-500 text-white py-2 rounded-lg text-sm font-bold w-full flex items-center justify-center gap-1.5"><Zap size={16}/> Terkini</button>
                    <button onClick={() => setCurrentPage("puan-yt-analysis")} className="bg-transparent border-2 border-red-500 text-red-400 hover:bg-red-900/50 py-2 rounded-lg text-sm font-bold w-full flex items-center justify-center gap-1.5"><PlaySquare size={16}/> YouTube</button>
                  </div>
                </div>
              </div>
