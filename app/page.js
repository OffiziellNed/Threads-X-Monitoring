...
export default function SocialMediaMonitoring() {
  ...
  const fetchLiveTrends = async () => {
    ...
    try {
      ...
      if (currentPage === "jakarta") { uTop = ["", pJkt].join("/") + epTop; uTerkini = ["", pJkt].join("/") + epTerkini; }
  ...
  if (currentPage === "puan-yt-analysis") {
    ...
    return (
      <main className="h-screen w-screen overflow-hidden bg-[#0d1117] flex flex-col items-center justify-center p-3 md:p-6">
        <div className="w-full max-w-5xl flex flex-col items-center justify-center gap-4 md:gap-6 h-full max-h-[100vh]">
          <div className="text-center shrink-0">
            <h1 className="text-3xl md:text-5xl font-black text-white tracking-tight drop-shadow-sm mb-2">Public Trend Radar</h1>
            <p className="text-gray-400 text-xs md:text-base font-medium">Monitoring isu publik terupdate secara real-time.</p>
          </div>

          {/* GRID 3x3 - 1 LAYAR TANPA SCROLL - DEPAN DOANG */}
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-5 w-full px-1 md:px-4 mt-2 md:mt-4">
            {/* 1. JAKARTA - BARU DI DEPAN */}
            <div className="bg-[#161b22] rounded-2xl p-3 md:p-5 border border-[#21262d] flex flex-col items-center justify-between text-center h-[165px] md:h-[210px] hover:border-orange-500/50 hover:shadow-[0_0_20px_rgba(249,115,22,0.15)] transition-all group cursor-pointer" onClick={() => setCurrentPage("jakarta")}>
              <img src="/jakarta.png" alt="Jakarta" className="w-16 h-16 md:w-24 md:h-24 rounded-2xl object-cover shrink-0 shadow-lg border border-[#1c2128] group-hover:scale-105 transition-transform" />
              <h2 className="text-white font-bold text-[13px] md:text-[16px] mt-2 leading-tight">Jakarta</h2>
              <button className="bg-[#374151] group-hover:bg-orange-600 text-white py-1.5 md:py-2 px-4 md:px-6 rounded-lg text-[10px] md:text-xs font-bold flex items-center gap-1.5 shadow-md w-max transition-colors mt-2"><Search size={12}/> Cek Sekarang</button>
            </div>

            {/* 2. NASIONAL */}
            <div className="bg-[#161b22] rounded-2xl p-3 md:p-5 border border-[#21262d] flex flex-col items-center justify-between text-center h-[165px] md:h-[210px] hover:border-blue-500/50 transition-all group cursor-pointer" onClick={() => setCurrentPage("nasional")}>
              <img src="/nasional.png" alt="Nasional" className="w-16 h-16 md:w-24 md:h-24 rounded-2xl object-cover shrink-0 shadow-lg border border-[#1c2128] group-hover:scale-105 transition-transform" />
              <h2 className="text-white font-bold text-[13px] md:text-[16px] mt-2 leading-tight">Berita Nasional</h2>
              <button className="bg-[#374151] group-hover:bg-[#4b5563] text-white py-1.5 md:py-2 px-4 md:px-6 rounded-lg text-[10px] md:text-xs font-bold flex items-center gap-1.5 shadow-md w-max transition-colors mt-2"><Search size={12}/> Cek Sekarang</button>
            </div>

            {/* 3. BENCANA */}
            <div className="bg-[#161b22] rounded-2xl p-3 md:p-5 border border-[#21262d] flex flex-col items-center justify-between text-center h-[165px] md:h-[210px] hover:border-red-500/30 transition-all group cursor-pointer" onClick={() => setCurrentPage("bencana")}>
              <img src="/bencana.png" alt="Bencana" className="w-16 h-16 md:w-24 md:h-24 rounded-2xl object-cover shrink-0 shadow-lg border border-[#1c2128] group-hover:scale-105 transition-transform" />
              <h2 className="text-white font-bold text-[13px] md:text-[16px] mt-2 leading-tight">Bencana Terkini</h2>
              <button className="bg-[#374151] group-hover:bg-[#4b5563] text-white py-1.5 md:py-2 px-4 md:px-6 rounded-lg text-[10px] md:text-xs font-bold flex items-center gap-1.5 shadow-md w-max transition-colors mt-2"><Search size={12}/> Cek Sekarang</button>
            </div>

            {/* 4. PDIP */}
            <div className="bg-[#161b22] rounded-2xl p-3 md:p-5 border border-[#21262d] flex flex-col items-center justify-between text-center h-[165px] md:h-[210px] hover:border-red-600/40 transition-all group cursor-pointer" onClick={() => setCurrentPage("pdip")}>
              <img src="/pdip.png" alt="PDIP" className="w-16 h-16 md:w-24 md:h-24 rounded-2xl object-cover shrink-0 shadow-lg border border-[#1c2128] group-hover:scale-105 transition-transform" />
              <h2 className="text-white font-bold text-[13px] md:text-[16px] mt-2 leading-tight">PDI Perjuangan</h2>
              <button className="bg-[#374151] group-hover:bg-[#4b5563] text-white py-1.5 md:py-2 px-4 md:px-6 rounded-lg text-[10px] md:text-xs font-bold flex items-center gap-1.5 shadow-md w-max transition-colors mt-2"><Search size={12}/> Cek Sekarang</button>
            </div>

            {/* 5. MEGAWATI */}
            <div className="bg-[#161b22] rounded-2xl p-3 md:p-5 border border-[#21262d] flex flex-col items-center justify-between text-center h-[165px] md:h-[210px] hover:border-red-600/40 transition-all group cursor-pointer" onClick={() => setCurrentPage("megawati")}>
              <img src="/megawati.png" alt="Megawati" className="w-16 h-16 md:w-24 md:h-24 rounded-2xl object-cover shrink-0 shadow-lg border border-[#1c2128] group-hover:scale-105 transition-transform" />
              <h2 className="text-white font-bold text-[13px] md:text-[16px] mt-2 leading-tight">Megawati</h2>
              <button className="bg-[#374151] group-hover:bg-[#4b5563] text-white py-1.5 md:py-2 px-4 md:px-6 rounded-lg text-[10px] md:text-xs font-bold flex items-center gap-1.5 shadow-md w-max transition-colors mt-2"><Search size={12}/> Cek Sekarang</button>
            </div>

            {/* 6. PUAN */}
            <div className="bg-[#161b22] rounded-2xl p-3 md:p-5 border border-[#21262d] flex flex-col items-center justify-between text-center h-[165px] md:h-[210px] hover:border-red-600/40 transition-all group cursor-pointer">
              <img src="/puan.png" alt="Puan" className="w-16 h-16 md:w-24 md:h-24 rounded-2xl object-cover object-top shrink-0 shadow-lg border border-[#1c2128] group-hover:scale-105 transition-transform" />
              <h2 className="text-white font-bold text-[13px] md:text-[16px] mt-2 leading-tight">Puan Maharani</h2>
              <div className="flex gap-1.5 mt-2">
                <button onClick={() => setCurrentPage("puan")} className="bg-[#374151] hover:bg-[#4b5563] text-white py-1.5 px-3 md:px-4 rounded-lg text-[10px] md:text-xs font-bold flex items-center gap-1 shadow-md transition-colors"><Search size={10}/> Cek</button>
                <button onClick={() => setCurrentPage("puan-yt-analysis")} className="bg-transparent text-gray-400 hover:bg-[#1c2128] hover:text-white py-1.5 px-2 md:px-3 rounded-lg text-[10px] md:text-xs font-bold flex items-center gap-1 transition-colors"><PlaySquare size={10}/> YT</button>
              </div>
            </div>
          </div>
        </div>
