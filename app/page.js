...
export default function SocialMediaMonitoring() {
  ...
  // =========================================================================
  // HALAMAN UTAMA (2 ATAS, 3 BAWAH, RATA TENGAH, UKURAN KARTU DIPERKECIL JADI 240px)
  // =========================================================================
  if (currentPage === "main") {
    // Ukuran kartu diperkecil dari 320px ke 240px agar muat satu halaman penuh tanpa scroll
    const boxCard = "relative group overflow-hidden rounded-2xl shadow-xl border border-[#30363d] bg-[#161b22] flex-none w-[240px] h-[240px]";

    return (
      <main className="min-h-screen p-6 bg-[#0d1117] text-gray-200 font-sans flex flex-col items-center">
        <div className="w-full max-w-[850px] space-y-6 mt-2 pb-10">
          <div className="text-center space-y-1">
            <h1 className="text-3xl md:text-4xl font-black text-white">Public Trend Radar</h1>
          ...
          <div className="flex flex-col items-center gap-5 w-full">
            ...
            <div className="flex flex-wrap justify-center gap-5 w-full">
              ...
              <div className={boxCard}>
                ...
                <div className="absolute inset-0 bg-black bg-opacity-80 backdrop-blur-sm flex flex-col items-center justify-center p-4 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <h2 className="text-lg font-black text-white mb-4 drop-shadow-md text-center leading-snug">Berita Nasional Umum</h2>
                  <div className="flex flex-col gap-2 w-full max-w-[190px]">
                    <button onClick={() => setCurrentPage("12jam")} className="bg-blue-600 hover:bg-blue-500 py-2 rounded-lg text-xs font-bold w-full flex items-center justify-center gap-1.5"><TrendingUp size={14}/> Top News</button>
                    <button onClick={() => setCurrentPage("terkini")} className="bg-blue-600 hover:bg-blue-500 py-2 rounded-lg text-xs font-bold w-full flex items-center justify-center gap-1.5"><Zap size={14}/> Terkini</button>
                  </div>
                </div>
              </div>
              ...
              <div className={boxCard}>
                ...
                <div className="absolute inset-0 bg-black bg-opacity-80 backdrop-blur-sm flex flex-col items-center justify-center p-4 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <h2 className="text-lg font-black text-orange-400 mb-4 drop-shadow-md text-center leading-snug">Berita Bencana Terkini</h2>
                  <div className="flex flex-col gap-2 w-full max-w-[190px]">
                    <button onClick={() => setCurrentPage("bencana-24jam")} className="bg-orange-600 hover:bg-orange-500 py-2 rounded-lg text-xs font-bold w-full flex items-center justify-center gap-1.5"><AlertTriangle size={14}/> Radar Bencana</button>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-wrap justify-center gap-5 w-full">
              ...
              <div className={boxCard}>
                ...
                <div className="absolute inset-0 bg-black bg-opacity-80 backdrop-blur-sm flex flex-col items-center justify-center p-4 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <h2 className="text-lg font-black text-red-500 mb-4 drop-shadow-md text-center leading-snug">PDI Perjuangan</h2>
                  <div className="flex flex-col gap-2 w-full max-w-[190px]">
                    <button onClick={() => setCurrentPage("pdip-12jam")} className="bg-red-600 hover:bg-red-500 py-2 rounded-lg text-xs font-bold w-full flex items-center justify-center gap-1.5"><TrendingUp size={14}/> Top News</button>
                    <button onClick={() => setCurrentPage("pdip-terkini")} className="bg-red-600 hover:bg-red-500 py-2 rounded-lg text-xs font-bold w-full flex items-center justify-center gap-1.5"><Zap size={14}/> Terkini</button>
                  </div>
                </div>
              </div>
              ...
              <div className={boxCard}>
                ...
                <div className="absolute inset-0 bg-black bg-opacity-80 backdrop-blur-sm flex flex-col items-center justify-center p-4 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <h2 className="text-lg font-black text-red-500 mb-4 drop-shadow-md text-center leading-snug">Megawati Soekarnoputri</h2>
                  <div className="flex flex-col gap-2 w-full max-w-[190px]">
                    <button onClick={() => setCurrentPage("megawati-12jam")} className="bg-red-600 hover:bg-red-500 py-2 rounded-lg text-xs font-bold w-full flex items-center justify-center gap-1.5"><TrendingUp size={14}/> Top News</button>
                    <button onClick={() => setCurrentPage("megawati-terkini")} className="bg-red-600 hover:bg-red-500 py-2 rounded-lg text-xs font-bold w-full flex items-center justify-center gap-1.5"><Zap size={14}/> Terkini</button>
                  </div>
                </div>
              </div>
              ...
              <div className={boxCard}>
                ...
                <div className="absolute inset-0 bg-black bg-opacity-80 backdrop-blur-sm flex flex-col items-center justify-center p-4 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <h2 className="text-lg font-black text-red-500 mb-4 drop-shadow-md text-center leading-snug">Puan Maharani</h2>
                  <div className="flex flex-col gap-2 w-full max-w-[190px]">
                    <button onClick={() => setCurrentPage("puan-12jam")} className="bg-red-600 hover:bg-red-500 py-1.5 rounded-lg text-[11px] font-bold w-full flex items-center justify-center gap-1"><TrendingUp size={13}/> Top News</button>
                    <button onClick={() => setCurrentPage("puan-terkini")} className="bg-red-600 hover:bg-red-500 py-1.5 rounded-lg text-[11px] font-bold w-full flex items-center justify-center gap-1"><Zap size={13}/> Terkini</button>
                    <button onClick={() => setCurrentPage("puan-yt-analysis")} className="bg-red-950 border border-red-500 hover:bg-red-900 py-1.5 rounded-lg text-[11px] font-bold w-full flex items-center justify-center gap-1"><PlaySquare size={13}/> YouTube Data</button>
                  </div>
                </div>
              </div>
